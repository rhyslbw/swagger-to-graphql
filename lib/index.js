...
var schemaFromEndpoints = function schemaFromEndpoints(endpoints, proxyUrl, options) {
  var gqlTypes = {};
  var queryFields = getFields(endpoints, false, gqlTypes, proxyUrl, options);
  ...
  var mutationFields = getFields(endpoints, true, gqlTypes, proxyUrl, options);
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (opts && opts.headers) {
                ...
                req.headers = (0, _assign2.default)(options.customHeaders || {}, req.headers, otherHeaders);
              }
...
var getFields = function getFields(endpoints, isMutation, gqlTypes, proxyUrl, options) {
...
var build = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(swaggerPath) {
    ...
    var swaggerSchema, refs, endpoints;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            return _context2.abrupt('return', schemaFromEndpoints(endpoints, proxyUrl, options));
